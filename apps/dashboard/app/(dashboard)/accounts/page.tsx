...
export default async function AccountsPage({
  ...
  const balanceResult = hasAccount ? await fetchBalance(account) : null
  const entriesResult = hasAccount ? await fetchEntries(account) : null
  ...
  return (
    <>
      ...
      {hasAccount && balanceResult !== null && !balanceResult.ok && (
        <EmptyState
          icon={Wallet}
