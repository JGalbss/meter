    ...
    <ApiReference
      ...
      intro={
        <p>
          ...
          {controlPlaneSpec.info.version}) — the same document served at <code>GET /openapi.json</code>{" "}
          and used to generate the dashboard's client types. This page is rebuilt from that contract, so
          it cannot drift from the live surface. For the engine surface see{" "}
          <a href="/api/engine">the engine API reference</a>, and for a narrative overview see{" "}
