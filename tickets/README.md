...
- [x] Provider usage adapters (Anthropic/Claude + Agent SDK, OpenAI, Vercel AI SDK): normalize usage, `recordModelUsage`, `meteredCall` — tested
- [x] Interim Python SDK + adapters (Anthropic/Claude, OpenAI) + `with_run` governance — stdlib-only, 8 tests
...
- [ ] More adapters: LangChain/LangGraph, Bedrock, Vertex; first-class per-client wrappers
