...
- [x] TS provider usage adapters (Anthropic/Claude + Agent SDK, OpenAI, Vercel AI SDK, Gemini/Vertex, Bedrock): normalize usage, `recordModelUsage`, `meteredCall` — 12 tests
- [x] Interim Python SDK + adapters (Anthropic/Claude, OpenAI, Gemini/Vertex, Bedrock) + `with_run` governance — stdlib-only, 10 tests
...
- [ ] More adapters: LangChain/LangGraph; first-class per-client auto-patch wrappers
