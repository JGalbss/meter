...
- [ ] Public docs site (Next.js + MDX) — API reference, concepts (ledger/budgets/events), self-host guide
- [ ] SDK pages: install/usage for TS + Python, adapter catalog, and SDK download links
- [ ] Generated API reference from the engine/control-plane OpenAPI once emitted; versioned docs
- [ ] Deploy alongside the dashboard; link from README
