...
- [~] Criterion microbench of the pricing hot path (`cargo bench -p meter-pricing`): `cost` ≈135 ns, `price_usage` ≈158 ns per event. Ledger reserve/settle bench + load harness + published results vs SLO.md pending
